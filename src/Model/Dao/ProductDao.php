...
class ProductDao extends Dao
{
    ...
    {
        $productObjct = new ProductObjectData();
        $sqlStmt = "SELECT t_typeofproducts.TOP_ID, t_typeofproducts.TOP_Name , t_typeofproducts.TOP_Description, t_productsphoto.PP_Photo , t_typeofproducts.TOP_DefaultPrice, t_typeofproducts.TOP_TVA, t_typeofproducts.TOP_Quantity, COUNT(t_rate.TOP_ID) AS rates, AVG(t_rate.Rate_Notation) AS average_rate FROM `t_typeofproducts`
        INNER JOIN t_productsphoto ON t_productsphoto.TOP_ID = t_typeofproducts.TOP_ID
